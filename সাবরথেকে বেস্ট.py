        ...
        try:
            ...
            if 'period' in last_signal_data:
                ...
                if prev_pred == 'SKIP':
                    ...
                    # টানা ৪টি লস হলে স্কিপ করার লজিক
                    if not is_win:
                        loss_count += 1
                        if loss_count >= 4:
            ...
            # স্কিপ রাউন্ড হ্যান্ডেল করার অংশ
            if skip_next_round:
                skip_next_round = False  
                loss_count = 0           
            ...
            # প্রতি ৫টি সিগন্যালের পর সতর্কতা পাঠানোর কাউন্টার
            signal_counter += 1
            ...
            # প্রতি ৫ সিগন্যাল পর পর সতর্কবার্তা পাঠানোর অংশ
